...
class DenseNet201:
    ...
    def transition_layer(self, x, num_output_features):
        ...
        x = Activation('relu')(x)
        # Convolution
        # print(num_output_features,1234)
    ...
    def run(self, input_shape, num_classes,num_init_features=64,bn_size=4,block_config=(6, 12, 48, 32),growth_rate=32):
